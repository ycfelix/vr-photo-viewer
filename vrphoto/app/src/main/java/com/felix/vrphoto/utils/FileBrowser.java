...
import com.felix.vrphoto.listeners.FileSelectHandler;
...
import com.felix.vrphoto.objects.MenuItem;
import com.felix.vrphoto.objects.Selectable;
import com.felix.vrphoto.vr.renderer.VRRenderer;
...
public class FileBrowser {
	...
	public FileBrowser(VRRenderer renderer) {
	...
	private void removeMenuFromView(VRRenderer renderer){
		for(MenuItem menu:displayList){
